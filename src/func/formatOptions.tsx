...
export const fortmatterDefaults = [
    {
        "TypeScript JSX (.tsx)": tsxFormatOptions,
        "JSON (.json)": jsonFormatOptions,
        "HTML (.html)": htmlFormatOptions,
        "Markdown (.md)": mdFormatOptions,
        "CSS (.css)": cssFormatOptions,
        "SCSS (.scss)": scssFormatOptions,
        "LESS (.less)": lessFormatOptions,
        "SVG (.svg)": svgFormatOptions,
        "Image (.png)": pngFormatOptions,
        "Image (.jpg)": jpgFormatOptions,
        "Image (.gif)": gifFormatOptions,
        "Image (.webp)": webmFormatOptions,
        "Font (.woff)": woffFormatOptions,
        "Font (.woff2)": woff2FormatOptions,
        "Video (.mp4)": mp4FormatOptions,
        "Video (.webm)": webmFormatOptions,
        "Audio (.mp3)": mp3FormatOptions,
        "PDF (.pdf)": pdfFormatOptions,
        "Text (.txt)": txtFormatOptions,
        "CSV (.csv)": csvFormatOptions,
        "YAML (.yaml)": undefined,
        "XML (.xml)": undefined,
        "GraphQL (.graphql)": undefined,
        "Shell Script (.sh)": shFormatOptions,
        "Dockerfile", : undefined,
        "Git Ignore (.gitignore)": gitignoreFormatOptions,
        "Env File (.env)": envFormatOptions,
    }
]